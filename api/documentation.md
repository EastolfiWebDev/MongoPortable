...
* [Collection](#Collection)
    ...
    * [.find([selection], [fields], [options], [callback])](#Collection+find) ⇒ <code>Array</code> &#124; <code>[Collection](#Collection)</code> &#124; <code>[Cursor](#Cursor)</code>
...
### collection.find([selection], [fields], [options], [callback]) ⇒ <code>Array</code> &#124; <code>[Collection](#Collection)</code> &#124; <code>[Cursor](#Cursor)</code>
Finds all matching documents

**Kind**: instance method of <code>[Collection](#Collection)</code>  
**Returns**: <code>Array</code> &#124; <code>[Collection](#Collection)</code> &#124; <code>[Cursor](#Cursor)</code> - If "options.chain" set to "true" returns this instance, if "options.forceFetch" set to true returns the array of documents, otherwise returns a cursor  
