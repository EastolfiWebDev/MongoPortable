...
describe("Selector", function() {
    describe("#Constructor", function() {
        ...
        it("should be able to compile a selection", function() {
            ...
            var _selector = Selector._compileSelector(selector);
    ...
    describe("#Matching", function() {
        describe("- Plain Fields", function() {
            it("should match on a string value", function() {
                ...
                // Matching value
                expect(Selector._compileSelector({
                    stringField: "yes"
                }).test(doc)).to.be.true;
    ...
    describe("#Methods", function() {
        describe("Selector->_matches", function() {
        ...
        describe("Selector->_compileSort", function() {
            it("should sort with a string", function() {
                ...
                sorted = results.sort(Selector._compileSort("stringField1"));
                ...
                sorted = results.sort(Selector._compileSort("stringField1 desc stringField2"));
                ...
                sorted = results.sort(Selector._compileSort("stringField1 stringField2"));
                ...
                sorted = results.sort(Selector._compileSort("stringField1 -1, stringField2 false"));
            ...
            it("should sort with an array", function() {
                ...
                sorted = results.sort(Selector._compileSort(["stringField1", "false", "stringField2"]));
            ...
            it("should sort with an object", function() {
                ...
                sorted = results.sort(Selector._compileSort({
